...
<?php foreach ($products as $product) : ?>
    <div class="col-md-4 game">
        ...
        <a href="<?php echo base_url(); ?>products/details/<?php echo $product->title; ?>">
            <img height="200" width= "200" src="<?php echo base_url(); ?>assets/images/products/<?php echo $product->image; ?>" alt="Game 1">
        </a>
